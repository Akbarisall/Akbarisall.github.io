...
game.IntroScreen = me.ScreenObject.extend({
	...
	onResetEvent : function () {
		...
		playOptions[0].text = 'Main bersama teman';
		...
		playOptions[1].text = 'Bermain dengan komputer (Mudah)';
		...
		playOptions[2].text = 'Bermain dengan komputer (Sulit)';
		...
		if ( hasExtraHard ) {
			...
			playOptions[3].text = 'Bermain dengan komputer (Ekstra-keras)';
